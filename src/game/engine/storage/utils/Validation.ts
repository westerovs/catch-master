import {DEFAULT_DATA, DEFAULT_DATA_VALUES, type PlayerProfile} from '../defaultData.ts'
import {parseJSON} from './utils.ts'

type DataType = 'number' | 'string' | 'object' | 'array' | 'bool'

const formatDataTo = (type: DataType, value: unknown) => {
...
export default class Validation {
  static validate = (data: unknown): PlayerProfile => {
