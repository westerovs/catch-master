...
import {ATLAS_RESOLUTIONS} from './src/game/config/resolutionConfig.mjs'

/**
 * Конфигурация сборки игровых ресурсов через AssetPack.
 *
 * MP3 из `raw-assets/audio` перекодируются из исходников по профилю своей
 * категории. Если сжатый файл не меньше оригинала, в сборку попадает исходник.
 */
